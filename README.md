...
1) Я бы выбрал модель Active-Passive, сделав бэкап на второй сервер. В случае выхода из строя первого, второй возьмет на себя нагрузку, работа клиентов будет продолжена без прерывания чего-то важного.

2) Также есть возможность, делать бэкапы всей инфраструктуры в 18:30 по будням в облако, когда сотрудники заканчивают работу. 
